            ...
            <div class="bg-white rounded-[2.5rem] p-10 shadow-sm border border-slate-100">
                <form action="{{ route('banners.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="titulo" id="titulo" placeholder="Ej: Realza tu Belleza Natural"
                        ...
                        @error('titulo') <p class="text-red-500 text-xs font-bold mt-1 ml-1">{{ $message }}</p> @enderror
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="subtitulo" id="subtitulo" rows="3" placeholder="Una breve frase motivadora..."
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="texto_boton" id="texto_boton" placeholder="Ej: Ver Servicios"
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="link_boton" id="link_boton" placeholder="Ej: #servicios"
                                   class="w-full bg-slate-50 border-none rounded-2xl py-4 px-6 focus:ring-2 focus:ring-indigo-500 transition-all font-bold text-slate-800">
                        </div>
                    </div>

                    <div class="space-y-2">
                        <label for="imagen" class="text-xs font-black text-slate-500 uppercase tracking-widest ml-1">Imagen del Banner (Grande)</label>
                        <div class="relative group">
                            ...
                            <div class="w-full bg-slate-50 border-2 border-dashed border-slate-200 rounded-3xl py-12 flex flex-col items-center justify-center group-hover:bg-indigo-50 group-hover:border-indigo-200 transition-all">
                                ...
                                <span class="text-lg font-bold text-slate-700">Subir imagen principal</span>
                                <p class="text-slate-400 text-xs mt-2 font-medium">Recomendado: 1920x1080px (Full HD) para máxima nitidez.</p>
                            </div>
                        </div>
                        @error('imagen') <p class="text-red-500 text-xs font-bold mt-1 ml-1">{{ $message }}</p> @enderror
                    </div>

                    <div class="flex items-center space-x-3 ml-1">
                        <input type="checkbox" name="activo" id="activo" checked class="w-6 h-6 text-indigo-600 border-slate-200 rounded-lg focus:ring-indigo-500">
                        <label for="activo" class="text-sm font-bold text-slate-700 uppercase tracking-wider">Activar inmediatamente</label>
                    </div>
